...
validation and are indexed in local Plex under Other Videos. Intel HDR case A AV1
...
not included in that speed. Intel DV series S03E02 HEVC Dolby Vision 8.1:
...
## NVIDIA DV test film sample playback approval (2026-09-06)
...
Prepared candidate: DV series B S01E07 on the media share, 3840x1608,
...
The 10-second DV series B S01E07 sample from the beginning passed in
...
Published `DV series B S01E07 - NVIDIA Dolby Vision P8.1 - 10s Test.mkv` in
...
passed. The full DV series B episode is running in
...
Full DV series B verification exposed two container-level differences: physical
...
- Source: DV series B S01E07, 2502.542 seconds, Profile 8.1.
...
- Plex: C:\MuxMender-Plex\DV series B S01E07 - NVIDIA Dolby Vision - Full Episode Verified.mkv
