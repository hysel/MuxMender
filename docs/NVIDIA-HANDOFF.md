...
|---|---:|---:|---:|---:|
| SDR test video | 9.262 | 6.766 | 2.496 | 26.95% |
...
- Full SDR test video SDR HEVC: user approved picture and synchronization; 26.95%
  reduction. Original audio/subtitle packets and frame timing were verified.
- HDR test video HDR10 HEVC and AV1 samples: user approved Sony TV and PC tests.
...
- Y:/Movies/SDR test video/SDR test video.mkv is the approved HEVC conversion.
...
- Y:/Movies/DV test film/DV test film.mkv is the approved repaired DV output.
  `DV test film.mkv.original-backup` preserves the original. Do not delete it.
- C:/MuxMender-Plex/DV test film.mkv retains the approved local repaired copy.
...
- `reports/nvidia-full-SDR test video-20260905-204727-7a3ce153/full-verification-210222-c6a7fdec/validation.json`
